...
.PHONY: ansible-lint ansible-check ansible-apply ansible-bootstrap-paths-test compose-reconcile-fixture terraform-apps-vm-lifecycle-test toolbox-uid-test cloud-init-test compose-config adguard-config-check gatus-config-check shellcheck secrets-scan preflight
...
compose-reconcile-fixture:
	./scripts/tests/compose-reconcile-fixture.sh
