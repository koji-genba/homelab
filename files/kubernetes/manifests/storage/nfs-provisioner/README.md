...
- **Export Path**: /mnt/tank-gen2/data/k8s-volumes
...
# ディレクトリ確認
ls -la /mnt/tank-gen2/data/k8s-volumes/
```
...
# ディスク使用量確認
du -sh /mnt/tank-gen2/data/k8s-volumes/*
```
...
ssh root@192.168.10.11
rm -rf /mnt/tank-gen2/data/k8s-volumes/<namespace>-<pvc-name>-<pv-name>
```
...
sudo mount -t nfs 192.168.10.11:/mnt/tank-gen2/data/k8s-volumes /mnt
ls -la /mnt
sudo umount /mnt
